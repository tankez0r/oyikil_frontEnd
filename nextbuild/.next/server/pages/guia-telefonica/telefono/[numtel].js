...
const getServerSideProps = async (context)=>{
    const numtel = context.params.numtel;
    const res = await fetch("https://api.cooperativaoyikil.com.ar/" + `guiatelefonica/telefono/${numtel}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [299], () => (__webpack_exec__(6128)));
